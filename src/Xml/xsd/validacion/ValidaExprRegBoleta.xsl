...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" 
	...
	extension-element-prefixes="dp" exclude-result-prefixes="dp dpconfig" version="1.0">
    ...
    <xsl:template match="/*">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:if test='not(regexp:match(cbc:ID,"^[B][A-Z0-9]{3}-[0-9]{1,8}?$"))'>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:if test='not(regexp:match(cbc:InvoiceTypeCode,"^(03)$"))'>
